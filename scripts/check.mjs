...
assert.equal(packageJson.version, '1.4.353', 'package version must be 1.4.353');
assert.match(fs.readFileSync(path.join(root, 'VERSION.txt'), 'utf8'), /V1\.4\.353\b/);
assert.match(fs.readFileSync(path.join(root, 'src', 'index.html'), 'utf8'), /V1\.4\.353\b/);
assert.match(fs.readFileSync(path.join(root, 'preload.js'), 'utf8'), /version:\s*['"]1\.4\.353['"]/);
