...
const sourceFiles = ['数据资产/标签/data-tags.js', '数据资产/标签/extra-tags.js', '数据资产/标签/synonyms.js', '数据资产/标签/search-keywords.js', '数据资产/标签/character-general-tags.json', '模型/tags-canary.json', '数据资产/角色/characters.json', '数据资产/角色/specific-tags.json', '数据资产/角色/manifest.json', '数据资产/标签/tag-enrichment.json'];
...
const record = metadataUpdateRecord(raw.data, base);
...
const artifacts = {
  ...
  'unified-tag-updates.json': JSON.stringify(record ? [record] : [], null, 2) + '\n',
