...
当前本地开发测试版为 **V1.4.335**，支持完整角色 Tag 直传、续轮上下文重置、最终提示词复制和中文界面语言约束。见 [V1.4.335 交付说明](交付说明-V1.4.335.md) 与 [当前执行计划](docs/superpowers/plans/2026-09-21-intent-routing.md)。此版本尚未推送或发布，下面的下载仍指向已发布版本。
