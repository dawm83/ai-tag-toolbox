...
当前本地开发测试版为 **V1.4.338**，支持普通反馈回到原生成任务、候选卡直接续轮和姿势反馈范围保护。见 [V1.4.338 交付说明](交付说明-V1.4.338.md) 与 [当前执行计划](docs/superpowers/plans/2026-09-21-intent-routing.md)。此版本尚未推送或发布，下面的下载仍指向已发布版本。
