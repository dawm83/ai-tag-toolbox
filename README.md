...
当前本地开发测试版为 **V1.4.342**，支持原任务续轮、图片按需读取、调用摘要、翻译查询索引、收藏懒加载、选择局部校验和聊天流式优化。见 [V1.4.342 交付说明](交付说明-V1.4.342.md) 与 [本地精简方案](docs/superpowers/specs/2026-09-22-local-tool-slimming-design.md)。此版本尚未推送或发布，下面的下载仍指向已发布版本。
