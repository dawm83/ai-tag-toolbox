...
`npm run check` 执行全部维护源码/脚本/测试的 Acorn 语法扫描、21 条 ESLint 正确性规则、架构护栏、模块测试、jsdom 页面测试和历史回归测试。2026-09-17 的 V1.4.32 本地维护构建共 215 项通过。Electron 实际关窗、真实 AI 和 ComfyUI 出图留给人工验收，本轮不调用付费接口、不推送、不发布。
