...
当前本地开发测试版为 **V1.4.335**，Tag 结果改为单个 `text` 代码块并提供复制全部按钮。见 [V1.4.335 交付说明](交付说明-V1.4.335.md) 与 [当前执行计划](docs/superpowers/plans/2026-09-21-intent-routing.md)。此版本尚未推送或发布，下面的下载仍指向已发布版本。
