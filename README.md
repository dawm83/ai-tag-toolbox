...
当前本地开发测试版为 **V1.4.334**，按明确任务意图限制工具，搜索和识图结果返回后直接回答，只要 Tag 时不会生图。见 [V1.4.334 交付说明](交付说明-V1.4.334.md) 与 [当前执行计划](docs/superpowers/plans/2026-09-21-intent-routing.md)。此版本尚未推送或发布，下面的下载仍指向已发布版本。
