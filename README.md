...
当前本地开发测试版为 **V1.4.349**：主 AI 直接看图并选择必要工具；本地识图只作初始提示；主 AI 会区分目标图、属性参考图和无关图片；迭代预算与角色 Tag 编译按绘图任务动态调度。见 [V1.4.349 交付说明](交付说明-V1.4.349.md)。此版本尚未推送或发布，下面的下载仍指向已发布版本。
