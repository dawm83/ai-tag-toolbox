...
更新日期：2026-09-17。代码版本：**V1.4.32 本地维护构建**。本文按当前源码核对，是后续开发的架构入口。

- 工作区：`F:\codex\AI绘画Tag工具箱\ai-tag-release-v143`，本轮维护提交在 `main`，未推送。
- 桌面测试包：`C:\Users\admin\Desktop\AI绘画Tag工具箱V1.4.32`，以包内 `build-info.json` 的 sourceCommit 区分维护构建。
