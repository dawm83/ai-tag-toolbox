...
const DEFINITIONS = Object.freeze({
  ...
  'generation.execute': { description: '生成 Tag 或图片：仅 Tag 时传 outputType=tags，绘图时传 images；程序会生成并评价 1 到 3 个候选、按需修订 Tag，并返回最佳图与每张图的实际提示词。用户已经提供完整角色 Tag 时放入 referenceTags，不能再把角色名拆成 characterQueries 查询；characterQueries 和 characterIds 仅用于只有名称、需要补资料或仍有歧义的角色。', parameters: generationExecuteSchema, outputSchema: { type: 'object' } },
