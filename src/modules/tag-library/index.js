...
module.exports = { ...schema, ...require('./library'), ...require('./commands'), ...require('./selection'), ...require('./repository'), ...require('./migration'), ...require('./tag-adapter'), ...require('./favorite-adapter'), loadBundledBase };
