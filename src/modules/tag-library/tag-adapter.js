...
function createTagAdapter({ library, metadataById = {}, categoryMetadata = DEFAULT_CATEGORIES, preferences, storage } = {}) {
  ...
  return Object.freeze({
    ...
    setQuery(value) { query = String(value ?? '').trim(); return query; },
    setCategory(value) { category = String(value ?? 'all'); return category; },
    setAdult(value) { includeAdult = Boolean(value); savePreference('rewrite_adult', includeAdult); return includeAdult; },
